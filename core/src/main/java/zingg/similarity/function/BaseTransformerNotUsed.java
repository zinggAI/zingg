...
public abstract class BaseTransformerNotUsed extends Transformer implements HasInputCol, HasOutputCol {
	...
	public static final Log LOG = LogFactory.getLog(BaseTransformerNotUsed.class);
	...
	@Override
    public BaseTransformerNotUsed copy(ParamMap paramMap) {
	...
	public BaseTransformerNotUsed() {
		
	}

	public BaseTransformerNotUsed(String name) {
		this.name = name;
	}
