...
public class Heuristics {
	...
	public static long getMaxBlockSize(long totalCount, long blockingTreeSizeFromConfig) {
		long maxSize = 8;
		/*if  (totalCount > 100 && totalCount < 500){
			...
			if (maxSize > blockingTreeSizeFromConfig) maxSize = blockingTreeSizeFromConfig;
