...
import zingg.spark.core.session.SparkSessionProviderLite;
import zingg.spark.core.context.ZinggSparkContext;

public class TestSparkBaseLite implements BeforeAllCallback, AfterAllCallback, ParameterResolver {
