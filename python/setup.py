...
LICENCEandREQUIREMENTS_PATH = os.path.join(ZINGG_HOME, "python/Examples")
...
LICENCEandREQUIREMENTS_TARGET = os.path.join(TEMP_PATH, "DOCs")
...
try:
    ...
    if (in_zingg):
        ...
        if _supports_symlinks():
            ...
            os.symlink(LICENCEandREQUIREMENTS_PATH, LICENCEandREQUIREMENTS_TARGET)
            ...
            copytree(LICENCEandREQUIREMENTS_PATH, LICENCEandREQUIREMENTS_TARGET)
    ...
    package_dir={
            ...
            'zingg.DOCs':'deps/DOCs',
            'zingg.phases': 'deps/phases'
        },
        package_data={
            'zingg.jars': ['zingg*.jar'],
            'zingg.scripts': ['*'],
            'zingg.DOCs':['LICENSE,requirements.txt'],
            'zingg.conf': ['*'],
            'zingg.phases': ['*'],
            '':['*.py'],
            '':['README.md']
    ...
    if (in_zingg):
        ...
        if _supports_symlinks():
            ...
            os.remove(os.path.join(TEMP_PATH, "DOCs"))
            ...
            rmtree(os.path.join(TEMP_PATH, "DOCs"))
