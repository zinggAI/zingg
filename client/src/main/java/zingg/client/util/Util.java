...
public class Util implements Serializable {
	...
	public static DataFrame addUniqueCol(DataFrame dupesActual, String colName) {
		...
		dupesActual = dupesActual.withColumn(colName,
				functions.concat(JavaConverters.asScalaIteratorConverter(Arrays.asList(dupesActual.col(colName + "temp"),
						dupesActual.col(colName)).iterator()).asScala().toSeq()));
		dupesActual = dupesActual.drop(toColsArray(dupesActual.col(colName + "temp")));
		return dupesActual;
	}
	...
	public static Column[] toColsArray(Column ... cols) {
		return cols.clone();
	}

	public static String[] toColsArray(String ... cols) {
		return cols.clone();
	}
}
