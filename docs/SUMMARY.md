...
* [Data Sources and Sinks](dataSourcesAndSinks/connectors.md)
  ...
  * [Snowflake](connectors/snowflake/README.md)
    * [Using Config JSON](connectors/snowflake/using-config-json.md)
    * [Using External Functions](connectors/snowflake/using-external-functions.md)
