...
* [Entity Resolution](zingg-concepts/entity-resolution/README.md)
  ...
  * [Zingg Entity Resolution Platform](zingg-concepts/entity-resolution/zingg-entity-resolution-platform.md)
  * [Deterministic vs Probabilistic Matching](zingg-concepts/entity-resolution/deterministic-vs-probabilistic-matching.md)
  * [Deduplication, linking and resolving](zingg-concepts/entity-resolution/deduplication-linking-and-resolving.md)
