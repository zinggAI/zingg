---
description: >-
  Connect Zingg to cloud warehouses and  analytics databases including
  Databricks,  Snowflake, BigQuery, Redshift, Fabric,  and Exasol.
---
...
Select your platform from the sub-pages below. Each page shows the Python API and JSON config for that platform, plus the supported file formats. Python and JSON produce identical results—use whichever matches your setup.
