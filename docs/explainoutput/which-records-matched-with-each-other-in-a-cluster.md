...
**In this release (0.7): Explain is supported for Snowflake & Spark via the command line. Python support became available from the 0.8 release onwards**
...
[summary-statistics.md](stats/summary-statistics.md)
