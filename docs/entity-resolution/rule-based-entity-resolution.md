...
# ⚙️ Rule based entity resolution
...
**Zingg's ML models solve all three:**

* Zingg learns variation from your data — roughly 30 - 50 labeled examples are enough to build a model that generalizes to patterns it has not seen before.
