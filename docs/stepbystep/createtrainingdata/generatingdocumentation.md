---
description: >-
  Generate readable HTML documentation of labeled training data for review by subject matter experts. Run the generateDocs phase to document matches and non-matches.
---
