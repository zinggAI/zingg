---
description: >-
  Zingg Enterprise Entity Resolution Python Package reference. Complete API documentation for ES package including ESparkClient and zinggES classes with example usage.
---
