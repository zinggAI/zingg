...
inputPipe = CsvPipe("test", 
    ...
    "id string, fname string, lname string, stNo string, add1 string, add2 string, city string, state string, areacode string, dob string, ssn  string", 
    )
...
outputPipe = CsvPipe("output", "/tmp", None)
