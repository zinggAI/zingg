...
public abstract class TestTrimPreprocess<S, D, R, C, T> {
    ...
    public TestTrimPreprocess(DFObjectUtil<S, D, R, C> dfObjectUtil, AMultiFieldPreprocessorUtility<S, D, R, C, T> multiFieldPreprocessorUtility, Context<S, D, R, C, T> context) throws ZinggClientException {
